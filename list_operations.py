...
def inner_four_end(input_list):
    ...
    list, in that order.
    """
    return [input_list[-6], input_list[-5], input_list[-4], input_list[-3]]
...
def custom_insert(input_list, index, value):
    ...
    """
    list1 = input_list[index:]
    del input_list[index:]
    input_list = custom_append(input_list, value)
    input_list = custom_extend(input_list, list1)
    return input_list
...
def custom_reverse(input_list):
    ...
    #temp_list = []
    #for i in range(custom_len(input_list)):
    #   custom_append(temp_list, custom_pop(input_list))
